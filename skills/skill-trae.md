...
Trae does not support PostToolUse hooks. Log events yourself after each significant action.
...
2. Create `.claude/lessons/sessions/<slug>/` with `meta.json` (include `"platform":"trae"`),
